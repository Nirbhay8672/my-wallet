<template>
    ...
    <main-page :page_name="'Expense Entries'">
                    ...
                    <table class="table table-hover align-middle">
                        ...
                        <tbody>
                            <tr v-for="entry in entries.data" :key="entry.id">
                                ...
                                <td style="min-width: 100px;" class="pt-4 text-center align-middle">
        ...
        <ExpenseEntryForm ref="expenseEntryForm" modal-id="expenseEntryModal" :entry="selectedEntry" :is-edit="!!selectedEntry" :accounts="accounts" :expense-types="expenseTypes" :url="page.props.url" :selected-account-id="filters.account_id" @reload="handleEntrySaved" />
    </main-page>
</template>
